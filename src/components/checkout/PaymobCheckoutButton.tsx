...
import { initiateCheckout } from '@/actions/paymob-payment-actions';
import { useTranslation } from '@/hooks/use-translation';

interface PaymobCheckoutButtonProps {
  packageId: string;
  buttonText?: string;
  className?: string;
...
export default function PaymobCheckoutButton({
  packageId,
  buttonText,
  className = '',
  variant = 'default'
}: PaymobCheckoutButtonProps) {
